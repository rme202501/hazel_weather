...
def merge_pollution_with_weather(pollution_csv, weather_csv, output_csv):
    ...
    print(f"Rows with weather data: {merged_df['date'].notna().sum()}")
    print(f"Rows without weather data: {merged_df['date'].isna().sum()}")
...
if __name__ == "__main__":
    ...
    bos_weather = r"c:\Users\ryane\OneDrive\Desktop\HazeL\hazel_weather\data\bosweather\bos_weather_utc.csv"
    
    # Process each Boston data folder
    data_base = r"c:\Users\ryane\OneDrive\Desktop\HazeL\hazel_weather\data"
    bos_folders = [
    ...
    for folder in bos_folders:
        ...
        if os.path.exists(folder_path):
            process_folder(folder_path, bos_weather, r"c:\Users\ryane\OneDrive\Desktop\HazeL\hazel_weather\data\merged_data")
