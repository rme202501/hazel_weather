...
# Load the data
import_path='2_bos_weather_utc.csv'
export_path='3_preprocessed_bos_weather_utc.csv'
...
# Save processed file
# Convert time (HH:MM) to numerical hour of the day
print("\nConverting time to numerical hour value...")
